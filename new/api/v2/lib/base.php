...
//			header('X-Powered-By: '.$this->hive['PACKAGE']); // оригинал
            header('X-Powered-By: Moto Helplist API, v.1');
			...
			if ($secs) {
				...
				header('Cache-Control: no-cache, no-store, must-revalidate'); // оригинал
/*
                header('Cache-Control: public, max-age=31536000'); 
                header('age: 166584');
                header('date: Tue, 19 Apr 2016 22:47:51 GMT');
                header('expires: Tue, 19 Apr 2017 22:47:51 GMT');
                header('last-modified: Thu, 14 Apr 2016 00:38:16 GMT');
*/
		}
	}
