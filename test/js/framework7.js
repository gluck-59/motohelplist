            ...
            form.find('input, select, textarea').each(function () {
                ...
                if (tag === 'select' && input.prop('multiple')) {
                    ...
                    switch (type) {
                        case 'checkbox' :
                            skipNames.push(name);
// ali was here                            formData[name] = [];
                            form.find('input[name="' + name + '"]').each(function () {
// ali was here                               if (this.checked) formData[name].push(this.value);
...
//ali was here            
            htmlTemplate = t7.compile('<div class="photo-browser photo-browser-{{theme}}">' +
        ...
        var Autocomplete = function (params) {
            ...
            a.open = function () {
                ...
                if (a.params.openIn === 'dropdown') {
                    ...
                    $(document).once('pageAfterAnimation', '.autocomplete-page', function(){a.searchbar.input.focus()});
